...
Blockly.Commands.ORDER_MEMBER = 1;         // . []
Blockly.Commands.ORDER_NEW = 1;            // new
Blockly.Commands.ORDER_FUNCTION_CALL = 2;  // ()
Blockly.Commands.ORDER_INCREMENT = 3;      // ++
Blockly.Commands.ORDER_DECREMENT = 3;      // --
Blockly.Commands.ORDER_LOGICAL_NOT = 4;    // !
Blockly.Commands.ORDER_BITWISE_NOT = 4;    // ~
Blockly.Commands.ORDER_UNARY_PLUS = 4;     // +
Blockly.Commands.ORDER_UNARY_NEGATION = 4; // -
Blockly.Commands.ORDER_TYPEOF = 4;         // typeof
Blockly.Commands.ORDER_VOID = 4;           // void
Blockly.Commands.ORDER_DELETE = 4;         // delete
Blockly.Commands.ORDER_MULTIPLICATION = 5; // *
Blockly.Commands.ORDER_DIVISION = 5;       // /
Blockly.Commands.ORDER_MODULUS = 5;        // %
Blockly.Commands.ORDER_ADDITION = 6;       // +
Blockly.Commands.ORDER_SUBTRACTION = 6;    // -
Blockly.Commands.ORDER_BITWISE_SHIFT = 7;  // << >> >>>
Blockly.Commands.ORDER_RELATIONAL = 8;     // < <= > >=
Blockly.Commands.ORDER_IN = 8;             // in
Blockly.Commands.ORDER_INSTANCEOF = 8;     // instanceof
Blockly.Commands.ORDER_EQUALITY = 9;       // == != === !==
Blockly.Commands.ORDER_BITWISE_AND = 10;   // &
Blockly.Commands.ORDER_BITWISE_XOR = 11;   // ^
Blockly.Commands.ORDER_BITWISE_OR = 12;    // |
Blockly.Commands.ORDER_LOGICAL_AND = 13;   // &&
Blockly.Commands.ORDER_LOGICAL_OR = 14;    // ||
Blockly.Commands.ORDER_CONDITIONAL = 15;   // ?:
Blockly.Commands.ORDER_ASSIGNMENT = 16;    // = += -= *= /= %= <<= >>= ...
Blockly.Commands.ORDER_COMMA = 17;         // ,
...
Blockly.Commands.init = function(workspace) {
  ...
  for (var i = 0; i < variables.length; i++) {
    defvars[i] = 'var ' +
        Blockly.Commands.variableDB_.getName(variables[i],
...
Blockly.Commands.finish = function(code) {
  ...
  for (var name in Blockly.Commands.definitions_) {
    definitions.push(Blockly.Commands.definitions_[name]);
  }
